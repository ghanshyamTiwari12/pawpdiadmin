...
class VerifiedLostPetBody extends StatefulWidget {
  const VerifiedLostPetBody({super.key});

  @override
  State<VerifiedLostPetBody> createState() => _VerifiedLostPetBodyState();
}

class _VerifiedLostPetBodyState extends State<VerifiedLostPetBody> {
    ...
    return ScrollConfiguration(
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            StreamBuilder(
                stream: AllPetScreenApi.verifiedLostPet(),
                    ...
                    snapshot)
                {
                  ...
                  return Center(
                    child: ShowText.detailsText("Verified Lost Pet unavailable",

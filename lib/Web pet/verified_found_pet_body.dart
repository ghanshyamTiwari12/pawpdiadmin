...
class VerifiedFoundPet extends StatefulWidget {
  const VerifiedFoundPet({super.key});

  @override
  State<VerifiedFoundPet> createState() => _VerifiedFoundPetState();
}

class _VerifiedFoundPetState extends State<VerifiedFoundPet> {
    ...
    return ScrollConfiguration(
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            StreamBuilder(
                stream: AllPetScreenApi.verifiedFoundPet(),

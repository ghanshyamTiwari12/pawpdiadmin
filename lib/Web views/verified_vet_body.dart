...
class VerifiedVetBody extends StatefulWidget {
  const VerifiedVetBody({super.key});

  @override
  State<VerifiedVetBody> createState() => _VerifiedVetBodyState();
}

class _VerifiedVetBodyState extends State<VerifiedVetBody> {
    ...
    return ScrollConfiguration(
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            StreamBuilder  (
                stream: AllUserScreenApi.verifiedVet(),
                    ...
                    snapshot)
                {
                  ...
                  return Center(
                    child: ShowText.detailsText("Verified Veterinarian unavailable",

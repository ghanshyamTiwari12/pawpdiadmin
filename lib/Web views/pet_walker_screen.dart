...
class PetWalkerScreen extends StatefulWidget {
  const PetWalkerScreen({super.key, required this.professionalType});
  final String professionalType;
  @override
  State<PetWalkerScreen> createState() => _PetWalkerScreenState();
}

class _PetWalkerScreenState extends State<PetWalkerScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      AppBar(
        ...
        toolbarHeight: 80,
        flexibleSpace: appBar(widget.professionalType) ,
              ...
              SizedBox(
                ...
                child:  Column(
                  ...
                  children: [
                    ...
                    SelectionCard.menuCard(context, Icons.account_circle, "Verified ${widget.professionalType}",1,
                            (){
                          selectedScreen = "Verified ${widget.professionalType}";
                    ...
                    SelectionCard.menuCard(context, Icons.account_circle, "Unverified ${widget.professionalType}",2,
                            (){
                          selectedScreen = "Unverified ${widget.professionalType}";
  ...
  Widget trainerSelectedScreen(context, int selectedScreen) {
    switch(selectedScreen){
      case 1:
        return  VerifiedPetWalkerBody(professionalType: widget.professionalType,);

      case 2:
        return UnverifiedPetWalkerBody(professionalType: widget.professionalType,);
  ...
  Widget appBar(String professionalType){

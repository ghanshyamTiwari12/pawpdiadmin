...
class UnverifiedProfessionalBody extends StatefulWidget {
  const UnverifiedProfessionalBody({super.key});

  @override
  State<UnverifiedProfessionalBody> createState() => _UnverifiedProfessionalBodyState();
}

class _UnverifiedProfessionalBodyState extends State<UnverifiedProfessionalBody> {
    ...
    return ScrollConfiguration(
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            StreamBuilder(
                stream: AllUserScreenApi.unVerifiedProfessional(),
                    ...
                    snapshot)
                {
                  ...
                  return Center(
                    child: ShowText.detailsText("UnVerified Professional unavailable",

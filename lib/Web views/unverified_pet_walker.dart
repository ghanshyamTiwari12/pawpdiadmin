...
class UnverifiedPetWalkerBody extends StatefulWidget {
  const UnverifiedPetWalkerBody({super.key, required this.professionalType});
  final String professionalType;

  @override
  State<UnverifiedPetWalkerBody> createState() => _UnverifiedPetWalkerBodyState();
}

class _UnverifiedPetWalkerBodyState extends State<UnverifiedPetWalkerBody> {
    ...
    return ScrollConfiguration(
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            StreamBuilder(
                stream: AllUserScreenApi.unVerifiedPetWalker(widget.professionalType),
                    ...
                    snapshot)
                {
                        ...
                        child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              if(_searchKeyword.isEmpty){
                                return ProfessionalCard.unVerifiedProfessionalCard(
                                  context,
                                  val['name'],
                                  ...
                                  professionalImageUrl: val['professionalImageUrl'] ?? '',
                                );
                  ...
                  return Center(
                    child: ShowText.detailsText("UnVerified ${widget.professionalType} unavailable",

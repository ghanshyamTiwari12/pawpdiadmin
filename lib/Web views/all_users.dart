...
class _AllUserScreenState extends State<AllUserScreen> {
            ...
            child: Row(
              children: [
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          SelectionCard.menuCard(
                              context, Icons.account_circle, "Users", 1, () {
                          ...
                          SelectionCard.menuCard(
                              context, Icons.account_circle, "Deleted Users", 2,
                              () {
                            // Provider.of<UserSelectionFunction>(context, listen: false).userSelectionFalse(context);
                          ...
                          SelectionCard.menuCard(context, Icons.account_circle,
                ...
                _isUserSelected
                    ...
                    : const SizedBox(),
                _isprofessionalSelected
                    ? ProfessionalDetailScreen(userID: _userID)
                    : const SizedBox(),
              ],
            ),
          ),
  ...
  Widget userSelectedScreen(context, int selectedIndex) {
    switch (selectedIndex) {
      ...
      case 10:
        return const VerifiedPetWalkerBody(
          professionalType: 'Pet Walker',
        );
      case 11:
        return const UnverifiedPetWalkerBody(
    ...
    return Padding(
      ...
      child: SizedBox(
          ...
          child: Row(
            children: [
              Center(
                child: ShowText.detailsText("All User",
              ...
              selectedScreen!.isNotEmpty
                  ? ShowText.detailsText(selectedScreen!,
                      color: Colors.white,
                      fontSize: 18,
                      fontWeight: FontWeight.bold)
                  : const SizedBox(
              ...
              _isUserSelected
                  ? ShowText.detailsText("                   $_userName",
                      color: Colors.black,
                      fontSize: 18,
                      fontWeight: FontWeight.bold)
                  : const SizedBox(
          ...
          InkWell(
              onTap: () {
                ...
                if (_isSearching == true) {
                  ...
                  Provider.of<UserSelectionFunction>(context, listen: false)
                      .userSelectionFalse(context);
                }
              },
              child: _isSearching
                  ? CardButton(
                      icons: CupertinoIcons.clear_circled_solid,

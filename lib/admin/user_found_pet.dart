...
//
// class UserFoundPetList extends StatefulWidget {
//   const UserFoundPetList({super.key, required this.userUid, required this.userName});
//   final String userUid;
//   final String userName;
//   @override
//   State<UserFoundPetList> createState() => _UserFoundPetListState();
// }
//
// class _UserFoundPetListState extends State<UserFoundPetList> {
...
//     return Scaffold(
//       appBar: AppBar(
//         title: Text("Found pet list of ${widget.userName}"),
//       ),
//       body: Column(
...
//                   if ("${val1['posted_id']}" == widget.userUid && "${val1['pet_status']}" == 'found'){
...
//                     child: Center(child: Text('${widget.userName} did not find any pet ',
//                       style: const TextStyle(
//                           fontSize: 30
//                       ),
//

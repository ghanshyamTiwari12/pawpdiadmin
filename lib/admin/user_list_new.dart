...
//           onChanged:(val){
//             _searchList.clear();
//             _searchList.add(DigitalDiaryApi.userSearch(val));
//
//             // for( var i in _list)
//             // {
...
//
//             StreamBuilder<QuerySnapshot>(
//                 stream: DigitalDiaryApi.userList(),
...
//                     // List<UserProfileModel> _list = [];
//                     // _list = data?.map((e) => UserProfileModel.fromMap(e.data() as Map<String, dynamic>?)).
//                     // where((element) => (element.isAdmin == false
//                     //     || element.isAdmin == null)).toList() ?? [];
//                     return Expanded(
//                       child: ListView.builder(
//                             itemCount: _isSearching ? _searchList.length : snapshot.data?.docs.length,
//                             itemBuilder: (context, index) {
//                               dynamic _list = snapshot.data?.docs[index];
...
//                                                                 // Spacer(),
//                                                                 CircleAvatar(
//                                                                   backgroundImage: NetworkImage(_list['profile_image_url'].toString()),
//                                                                   radius: 20,
//                                                                 ),
//                                                               ],
//                                                             ),
